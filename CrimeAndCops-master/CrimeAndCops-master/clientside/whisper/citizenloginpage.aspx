<%@ Page Title="" Language="C#" MasterPageFile="~/clientside/whisper/afterloginMasterPage.master" AutoEventWireup="true" CodeFile="citizenloginpage.aspx.cs" Inherits="clientside_whisper_citizenloginpage" %>
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                <%--<input type="submit" value="Send Message" class="btn btn-primary py-3 px-5">--%>
                  ...
                  <a href="registrationcitizen.aspx">Do you want to register yourself?</a>
              </div>
