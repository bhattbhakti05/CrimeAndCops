...
public partial class clientside_whisper_whisper_loginpage : System.Web.UI.Page
{
	...
	protected void Button1_Click(object sender, EventArgs e)
	{
		...
		cmd.CommandText = "select count(*) from lawyer_db where l_unm='" + txtunm.Text + "' and pwd='" + txtpwd.Text + "'";
		...
		if (k == 1)
		{
			...
			Response.Redirect("~/clientside/whisper/lawyer_home.aspx");
		}
		else
		{
