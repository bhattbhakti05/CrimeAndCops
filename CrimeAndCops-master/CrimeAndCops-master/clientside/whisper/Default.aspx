<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="clientside_whisper_Default" %>
...
<%--<cc1:ModalPopupExtender ID="mp1" runat="server" PopupControlID="Panl1" TargetControlID="Button1"
    ...
    CancelControlID="Button2" BackgroundCssClass="Background">
        ...
        <ajaxToolkit:ModalPopupExtender ID="ModalPopupExtender1"PopupControlID="Panl1" TargetControlID="Button1" CancelControlID="Button2" BackgroundCssClass="Background" runat="server"></ajaxToolkit:ModalPopupExtender>
