<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/AdminMasterPage.master" AutoEventWireup="true" CodeFile="city.aspx.cs" Inherits="AdminPanel_city" %>
		...
		<div class="col-md-12">
	        <div class="card">
	            <div class="card-header">
	                <h4 class="card-title" id="horz-layout-icons">City Detail</h4>
	                    ...
	                    <form class="form form-horizontal">
	                    	<div class="form-body">
	                			<div class="form-group row">
		                            <label class="col-md-3 label-control" for="timesheetinput1">Select District </label>
&nbsp;<div class="col-md-9">
			                            <div class="position-relative has-icon-left">
                                            <asp:DropDownList ID="DropDownList2" runat="server" AutoPostBack="True" DataSourceID="SqlDataSource1" DataTextField="d_name" DataValueField="d_Id"></asp:DropDownList>
                                ...
                                <div class="form-group row">
		                            <label class="col-md-3 label-control" for="timesheetinput1">Taluka Name</label>
		                            <div class="col-md-9">
			                            <div class="position-relative has-icon-left">
                                            <asp:TextBox ID="TextBox1" runat="server"  class="form-control" placeholder="Enter city"></asp:TextBox>
			                            	<%--<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Bhakti %>" SelectCommand="SELECT [l_Id] FROM [Lawyer_master]"></asp:SqlDataSource>--%>
			                            	<%--<input type="text" id="timesheetinput1" class="form-control" placeholder="employee name" name="employeename">--%>
				                            <div class="form-control-position">
				                               <%-- <i class="ft-user"></i>--%>
